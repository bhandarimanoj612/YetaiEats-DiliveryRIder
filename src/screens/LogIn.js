...
const LogIn = () => {
  ...
  return (
    ...
    <View className="flex-1 bg-green-600 flex-col justify-end">
      ...
      <View className="justify-end flex-row mb-10 mr-5">
        ...
        <TouchableOpacity>
          <Text className="text-white font-semibold">Welcome! Riders</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="bg-white h-[85%] rounded-[45px] rounded-b-none">
        ...
        <TouchableOpacity
          onPress={handleLogin}
          className="rounded-2xl bg-green-600 items-center justify-center w-60 mx-20 mt-[10%] h-16"
        >
          <View>
