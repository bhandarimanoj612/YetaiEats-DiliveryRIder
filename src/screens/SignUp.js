    ...
    return (
      <Modal visible={openModal} transparent={true} animationType="slide">
        <View className="flex-1 justify-end bg-transparent items-center flex-col">
          <View
            className="bg-white rounded-3xl rounded-b-none"
            style={{ height: 450, width: 414 }}
          >
            <TouchableOpacity
              onPress={() => {
                setOpenModal(false);
            ...
            <TouchableOpacity
              ...
              className="bg-gray-100 h-14 rounded-3xl flex-row items-center justify-center"
              style={{ width: 230, marginHorizontal: 80, marginTop: 50 }}
            >
              <Text className="font-bold text-xl text-green-400">
                Individual Cook
              </Text>
            </TouchableOpacity>
    ...
    <View className="bg-green-600 flex-1 flex-col justify-end">
      ...
      <View className="bg-white rounded-[45px] h-[85%] rounded-b-none">
        ...
        <Image
          ...
          className="w-[75%] h-[35%] ml-12 mt-14"
        />
        ...
        <TouchableOpacity
          onPress={() => {
            navigation.navigate("DeliveryRiderSighup");
          }}
          className="bg-green-600 h-14 rounded-3xl flex-row items-center justify-center"
