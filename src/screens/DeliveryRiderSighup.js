...
const DeliveryRiderSighup = () => {
  ...
  const handleSignUp = () => {
    const signUpData = {
      ...
      role: "DELIVERY RIDER", // Assuming this is a default value
    };
  ...
  return (
    <View className="flex-1 flex-col">
      <View>
        <Text className="mt-20 ml-6 font-extrabold text-green-600 text-3xl">
          YetaiEats Rider
        </Text>
        <Text className="ml-6 mt-3 font-thin text-lg">Join YetaiEats Now!</Text>
        <View className="h-[85%] bg-green-600 rounded-[50px] rounded-b-none">
...
export default DeliveryRiderSighup;
